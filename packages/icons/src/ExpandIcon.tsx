    ...
    <IconWrapper display={display} size={size} color={color}>
      ...
      >
        ...
        <path
          ...
          fillRule="evenodd"
          clipRule="evenodd"
          d="M14.001.998a.999.999 0 011-.998h4a1 1 0 011 .998L20 5.032a.999.999 0 01-2 0V3.418l-4.29 4.311c-.39.391-1.023.393-1.415.004a.996.996 0 01-.004-1.41l4.306-4.327h-1.596c-.552 0-1-.447-1-.998zM7.706 12.267a.996.996 0 01.004 1.41l-4.306 4.327H5A.999.999 0 115 20H1a1.001 1.001 0 01-1-.998l.001-4.034a.999.999 0 012 0v1.614l4.291-4.311a1.001 1.001 0 011.414-.004z"
        />
      </svg>
    </IconWrapper>
  );
