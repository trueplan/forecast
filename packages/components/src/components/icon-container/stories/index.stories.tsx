...
export const Small: React.FC = () => (
  <Stack spacing="$35">
    <IconContainer color="blue" size="small">
      <CheckIcon decorative={false} title="Check" size="xxsmall" />
    </IconContainer>
    <IconContainer color="green" size="small">
      <ChatIcon decorative={false} title="Chat" size="xxsmall" />
    </IconContainer>
    <IconContainer color="lilac" size="small">
      <HomeIcon decorative={false} title="Home" size="xxsmall" />
    </IconContainer>
    <IconContainer color="red" size="small">
      <SearchIcon decorative={false} title="Search" size="xxsmall" />
    </IconContainer>
    <IconContainer color="royal" size="small">
      <ArrowSwapIcon decorative={false} title="Swap" size="xxsmall" />
    </IconContainer>
    <IconContainer color="sky" size="small">
      <LocationIcon decorative={false} title="Location" size="xxsmall" />
    </IconContainer>
    <IconContainer color="yellow" size="small">
      <StarIcon decorative={false} title="Star" size="xxsmall" />
    </IconContainer>
  </Stack>
);
