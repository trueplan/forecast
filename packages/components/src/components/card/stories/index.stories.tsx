...
export const Padding: React.FC = () => <Card padding="space60">This is the content.</Card>;

export const TopPadding: React.FC = () => <Card paddingTop="space60">This is the content.</Card>;
...
export const BottomPadding: React.FC = () => <Card paddingBottom="space60">This is the content.</Card>;

export const LeftPadding: React.FC = () => <Card paddingLeft="space60">This is the content.</Card>;
